...
#if defined(CONFIG_MACH_KONA_EUR_LTE) || defined(CONFIG_TARGET_LOCALE_USA)
	i2c_register_board_info(1, i2c_devs1, ARRAY_SIZE(i2c_devs1));
#else
	if (system_rev >= 1)
		i2c_register_board_info(1, i2c_devs1,
					ARRAY_SIZE(i2c_devs1));
	else
		i2c_register_board_info(1, i2c_devs1_1,
					ARRAY_SIZE(i2c_devs1_1));
#endif
#endif
#ifdef CONFIG_SENSORS_YAS532
	/* magnetic sensor */
